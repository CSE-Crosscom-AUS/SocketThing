...
{
    public class IridiumSBDSession : AppSession<IridiumSBDSession, IridiumSBDRequestInfo>
    {
        ...
        protected override void OnSessionStarted()
        {
            ...
            //this.Send("Welcome to SuperSocket IridiumSBD Server");
        ...
        internal void AcknowledgeData(IridiumSBDRequestInfo requestInfo)
        {
